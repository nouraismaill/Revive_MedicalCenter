  ...
  return (
    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-10">
      <div className="flex items-center justify-between">
        <p class="text__para mt-0 font-semibold">Ticket Price</p>
      ...
      <button class=" w-full cursor-pointer  h-12 bg-blue-600 text-white rounded-lg hover:bg-blue-700 hover:shadow-lg transition-all group active:w-11 active:h-11 active:rounded-full active:duration-300 ease-in-out">
        <svg
        ...
        <span class="group-active:hidden">Book Appointment</span>
      </button>
    </div>
  );
};
